...
namespace sccccc
{
    ...
    public class StringCalculator
    {
        public int Add(string value, string[] separator)
        {
            ...
            //foreach (string s in value.Split(new[] { ",", Environment.NewLine }, StringSplitOptions.None))
        ...
        public int Add(string value, string secondValue, string[] separator)
        {
            ...
            foreach (string s in value.Split(separator, StringSplitOptions.None))
            {
                temp.Add(s.Replace("Bardzo", "").Replace("Lubie", "").Replace("Jendka", ""));
            }

            //string[] temp2 = secondValue.Split(',');
        ...
        private static int Extractor(string[] temp)
        {
            int returnValue = 0;
        ...
        private static int Extractor(List<string> temp)
        {
            int returnValue = 0;
            foreach (string stringNumber in temp)
            {
        ...
        private static bool IsPositiveAndSmallerThan1000(int intNumber)
        {
