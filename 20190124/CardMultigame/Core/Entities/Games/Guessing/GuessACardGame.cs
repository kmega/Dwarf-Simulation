...
namespace Core.Entities.Games
{
    public class GuessACardGame : IGameImplementation
    {
        ...
        {
            List<IGameCondition> gameConditions = new List<IGameCondition>();
            gameConditions.Add(new DidGuessACard());
        ...
        {
            ICardComparisonStrategy selectedStrategy = new StrictCardComparisonStrategy();
