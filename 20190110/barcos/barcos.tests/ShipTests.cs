...
namespace Tests
{
    public class ShipTests
    {
        ...
        public void CreateTwoMastShipAndCheckHisState()
        {
            ...
            Ship newShip = shipFactory.CreateTwoMastsShip(ShipOrientation.horizontally, 1, 2);
        ...
        public void CreateThreeMastShipAndCheckHisState()
        {
            ...
            Ship newShip = shipFactory.CreateThreeMastsShip(ShipOrientation.horizontally, 1, 2);
        ...
        public void CreateFourMastShipAndCheckHisState()
        {
            ...
            Ship newShip = shipFactory.CreateFourMastsShip(ShipOrientation.horizontally, 1, 2);
        ...
        public void CreateFourFiveShipAndCheckHisState()
        {
            ...
            Ship newShip = shipFactory.CreateFiveMastsShip(ShipOrientation.horizontally, 1, 2);
