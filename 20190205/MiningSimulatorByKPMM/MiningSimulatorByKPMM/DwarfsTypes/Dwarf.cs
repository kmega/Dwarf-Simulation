...
namespace MiningSimulatorByKPMM.DwarfsTypes
{
    public class Dwarf
    {
        ...
        public List<E_MineralsType> PersonalEquipment { get; private set; }
        ...
        {
            PersonalEquipment = new List<E_MineralsType>();
        }
        public void AddMinedMaterial(E_MineralsType e_Mineral)
        {
            PersonalEquipment.Add(e_Mineral);
        }
        public void RemoveSingleMaterialFromEquipment(E_MineralsType e_Mineral)
        {
