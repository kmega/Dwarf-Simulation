...
namespace Chicken_Kitchen
{
    class Allergy_Ingredients
    {
        ...
        public Allergy_Ingredients()
        {
            ...
            _dictionary_allergy_ingredients.Add(Customer.Elon_Carosel, new List<Ingredient>() {Ingredient.Vinegar, Ingredient.Olives});
            _dictionary_allergy_ingredients.Add(Customer.Adam_Smith, new List<Ingredient>() { });
            _dictionary_allergy_ingredients.Add(Customer.Barbara_Smith, new List<Ingredient>() {Ingredient.Chocolate });
            _dictionary_allergy_ingredients.Add(Customer.Christian_Donnovan, new List<Ingredient>() {Ingredient.Paprika });
            _dictionary_allergy_ingredients.Add(Customer.Bernard_Unfortunate, new List<Ingredient>() {Ingredient.Potatoes });
        }
